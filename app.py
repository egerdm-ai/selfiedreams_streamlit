...
st.markdown("<h1 style='text-align: center; color: #c770f0;'>Efe Generator</h1>", unsafe_allow_html=True)


left_column, main_column, right_column = st.columns([5,5,5])
img = Image.open('app_images_2/love.png')
new_width = 256
...
st.markdown("<h2 style='text-align: center;'>Try the AI model that can generate images of Efehan!</h2>", unsafe_allow_html=True)
st.markdown("<p style='text-align: center;'>You have to mention him as 'kefe_clk' 🙃</p>", unsafe_allow_html=True)
...
prompt = left_column.text_input('Enter your prompt:', 'a selfie of kefe_clk with Rihanna')
st.markdown("""
<style>
    .stButton>button {
        color: white;
...
# Load images
image1 = Image.open('app_images_2/art.png')
image2 = Image.open('app_images_2/gambit.png')
image3 = Image.open('app_images_2/got.png')
image4 = Image.open('app_images_2/animation.png')
...
holder1.image(image2,caption ='a portrait of kefe_clk person as X-Men Gambit character')
holder2.image(image3,caption ='a portrait of kefe_clk person as Game of Thrones character')
holder3.image(image4,caption ='a portrait of kefe_clk person as animation')
holder4.image(image1,caption ='a pop art style photo of kefe_clk')
...
if button:
    ...
    with st.spinner('Loading...'):
        ...
        url = "https://fair-results-melt.loca.lt/text2img"
